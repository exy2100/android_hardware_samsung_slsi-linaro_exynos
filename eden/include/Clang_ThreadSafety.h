...
// CAPABILITY is an attribute on classes, which specifies that objects of the class can be used as a capability.
// The analysis ensures that the calling thread cannot access the resource unless it has the capability
...
// SCOPED_CAPABILITY is an attribute on classes that implement RAII-style locking,
// in which a capability is acquired in the constructor, and released in the destructor.
