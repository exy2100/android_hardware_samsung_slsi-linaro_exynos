...
class ICNNNetReader : public details::IRelease {
  public:
    ...
    */
    ...
    virtual StatusCode SetSCaffeWeights(const TBlob<int8_t>::Ptr &weights, const TBlob<int8_t>::Ptr &biases, ResponseDesc *resp) noexcept = 0;

    virtual StatusCode ReadWeightsBias(TBlob<int8_t>::Ptr &weightbufPtr, TBlob<int8_t>::Ptr &biasbufPtr,
                                         ResponseDesc *resp) = 0;

    virtual StatusCode ReadWeightsBias(const char *wfilepath, const char *bfilepath,
                                         ResponseDesc *resp) = 0;
