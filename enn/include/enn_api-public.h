...
/**
 * @brief Unset all ext-buffers for model
 *
 * @param model_id model ID from load_model
 * @return EnnReturn zero if successful
 */
extern EnnReturn EnnUnsetBuffers(const EnnModelId model_id);
...
/**
 * @brief Uncommit user-defined buffers that a context holds. For simple API, you can uncommit only one buffer set.
 *
 * @param model_id model ID that returns from OpenModel()
 * @return EnnExecuteModelId
 */
extern EnnReturn EnnBufferUncommit(const EnnModelId model_id);
...
/**
 * @brief Uncommit Buffer with selective session
 *
 * @param model_id model ID from load_model
 * @param session_id session ID in user's session
 * @return EnnExecuteModelId zero if successful
 */
extern EnnReturn EnnBufferUncommitWithSessionId(const EnnModelId model_id, const int session_id);
 ...
 * @return EnnReturn zero if successful
 */
extern EnnReturn EnnUnsetBuffersWithSessionId(const EnnModelId model_id, const int session_id);
...
extern EnnReturn EnnGetMetaInfo(const EnnMetaTypeId info_id, const EnnModelId model_id,
